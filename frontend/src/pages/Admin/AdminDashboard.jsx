...
import { Users, Calendar, CreditCard, TrendingUp, Eye, Edit, Edit3, Trash2, Plus, X, Check, XCircle, Clock, AlertCircle, CheckCircle, RefreshCw, Search, Filter, ChevronLeft, ChevronRight, UserCheck, UserX, Activity, DollarSign, Settings, FileText, Mail, Phone, MapPin, Building, User, Stethoscope, CalendarPlus, Receipt } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  const handleAppointmentStatusChange = async (appointmentId, newStatus) => {
    try {
      await adminAPI.overrideAppointment(appointmentId, { status: newStatus });
                ...
                <div className="flex justify-end space-x-2 pt-4">
                  {selectedAppointment.status === 'pending' && (
                    <>
                      ...
                      <button
                        onClick={() => {
                          handleAppointmentStatusChange(selectedAppointment.id, 'rejected');
                          setShowAppointmentModal(false);
                        }}
