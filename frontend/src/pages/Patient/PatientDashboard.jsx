                    ...
                    >
                      <div>
                        ...
                        <div className="flex items-center space-x-2">
                          <UserCheck className="w-4 h-4 text-green-600" />
                          <p className="text-sm font-semibold text-gray-700">
                            Dr. {payment.appointment?.dentist?.full_name}
                          </p>
                        </div>
                        <div className="flex items-center space-x-2 mt-1">
                          <Calendar className="w-4 h-4 text-purple-600" />
                          <p className="text-sm font-semibold text-gray-600">
                            <span className="font-bold">Appointment:</span> {formatSafeDate(payment.appointment?.appointment_time)}
                          </p>
                        </div>
                        <div className="flex items-center space-x-2">
                          <Receipt className="w-3 h-3 text-green-500" />
                          <p className="text-xs font-semibold text-gray-500">
                            <span className="font-bold">Payment Created:</span> {formatSafeDate(payment.created_at)}
                          </p>
                        </div>
                      </div>
